...
- Each test case consists of multiple lines of input. The first line of each test case contains two space-separated integers $N$ and $X$ — the number of items and the minimum freshness value an item should have. The second line contains $N$ space-separated integers, the array $A$, denoting the freshness value of each item. The third line contains $N$ space-separated integers, the array $B$, denoting the cost of each item.
### Output Format
...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-08-20T14:59:17.304Z  
