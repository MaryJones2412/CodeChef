...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-08-31T08:52:51.784Z  
...
squareNumbersAsync(
  numbers,
  function (originalNumber, squaredNumber) {
    console.log('Squared number of ' + originalNumber + ': ' + squaredNumber);
  },
  function (allSquaredNumbers) {
    console.log('All squared numbers: ' + allSquaredNumbers);
  }
);
